...
**Phase 0A is complete; Z product implementation has not started.** Exact implementation inputs and roots are materialized under [`docs/reference/IMPLEMENTATION-ROOTS.md`](docs/reference/IMPLEMENTATION-ROOTS.md), with evidence in [`evidence/checkpoints/phase-0a-implementation-bootstrap-20260801/`](evidence/checkpoints/phase-0a-implementation-bootstrap-20260801/). Phase 0B and Phase 1 have not started, no guest or machine exists, and no runtime or release claim is made. The next permitted mission is Phase 0B only after separate authorization. The complete ledger is [`docs/STATUS.md`](docs/STATUS.md).
